{
	...
	function exec {
		...
		parameter v is n:burnvector.
		parameter starttime is time:seconds + n:eta - mnv_time(v:mag)/2.
	...
	function seek {
		parameter t, r, n, p, fitness, data is list(t, r, n, p), fit is orbit_fitness(fitness@).
	...
	function seek_SOI {
		parameter target_body, target_periapsis, start_time is time:seconds + 600.
	...
	function optimize {
		parameter data, fitness, step_size, winning is list(fitness(data), data), improvement is best_neighbor(winning, fitness, step_size).
